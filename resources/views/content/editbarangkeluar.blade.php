...
@endif
    ...
    <div class="py-4 px-3 px-md-4">
        <h1 class="text-center mb-4">Edit Data Barang dan barang yang ingin dikeluarkan  </h1>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <div class="modal-body">
                                            <form action="/update/{{$barang->idbarang}}/databarang" method="post"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="mb-3">
                                                    <label for="inputnamabarang" class="form-label">Nama Barang </label>
                                                    <input readonly type="text" name="namabarang" class="form-control"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input readonly type="text" name="jenisbarang" class="form-control"
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input readonly type="text" name="varian" class="form-control" id="varian"
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input readonly type="text" name="satuan" class="form-control"
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input readonly type="text" name="harga" class="form-control"
                                                ...
                                                <div class="mb-2">
                                                    <label for="exampleInputpenanggungjawab" class="form-label">Total barang ini yang akan dikeluarkan</label>
                                                    <input type="text" name="stokkeluar" class="form-control"
                                                        id="stokkeluar" aria-describedby="inputJabatan" >
                                                    <div id="stok" class="form-text">Jangan Kosongkan untuk jumlah yang ingin dikeluarkan</div>
                                                </div>
