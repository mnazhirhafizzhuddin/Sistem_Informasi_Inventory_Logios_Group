    ...
    <main class="main">
        ...
        <aside id="sidebar" class="js-custom-scroll side-nav">
            <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
                ...
                <!-- Dashboard -->
                <li class="side-nav-menu-item {{request()->is ('panel/dashboardmanager') ?'active' : ''}}">
                    <a class="side-nav-menu-link media align-items-center " href="/dashboardmanager">
                ...
                <ul class="list-unstyled ps-0">
                    <li class="mb-1">
                        ...
                        <div class="collapse" id="home-collapse" style="">
                            <ul id="subUsers" class="side-nav-menu side-nav-menu-second-level mb-0">
                                ...
                                <li class="side-nav-menu-item">
                                    <a class="side-nav-menu-link" href="/databarang1">Data Barang</a>
                                </li>
                                {{-- <li class="side-nav-menu-item">
                    ...
                    <li class="mb-1">
                        ...
                        <div class="collapse" id="dashboard-collapse" style="">
                            <ul id="subUsers" class="side-nav-menu side-nav-menu-second-level mb-0">
                                <li class="side-nav-menu-item">
                                    <a class="side-nav-menu-link " href="/databarangmasuk1">Data Barang Masuk </a>
                                </li>
                                <li class="side-nav-menu-item">
                                    {{-- <a class="side-nav-menu-link {{request()->is ('datakaryawan') ?'active' : ''}}"
                                        href="/datakaryawan">Data Karyawan</a> --}}
                                ...
                                <li class="side-nav-menu-item">
                                    <a class="side-nav-menu-link" href="/databarangkeluar2">Data Barang Keluar </a>
                                </li>
                                {{-- <li class="side-nav-menu-item">
                    ...
                    <li class="mb-1">
                        ...
                        <div class="collapse" id="orders-collapse" style="">
                            <ul id="subUsers" class="side-nav-menu side-nav-menu-second-level mb-0">
                                <li class="side-nav-menu-item">
                                    <a class="side-nav-menu-link " href="/laporanbarangmasuk1">Laporan Barang Masuk </a>
                                </li>
                                <li class="side-nav-menu-item">
                                    {{-- <a class="side-nav-menu-link {{request()->is ('datakaryawan') ?'active' : ''}}"
                                        href="/datakaryawan">Data Karyawan</a> --}}
                                ...
                                <li class="side-nav-menu-item">
                                    <a class="side-nav-menu-link" href="/laporanbarangkeluar1">Laporan Barang Keluar</a>
                                </li>
                                {{-- <li class="side-nav-menu-item">
                    ...
                    <li class="mb-1">
                        <div class="collapse" id="orders-collapse" style="">
                            <li class="side-nav-menu-item">
                                <a class="side-nav-menu-link" href="/proseslogoutmanager">Logout</a>
                            </li>
                        </div>
                    </li>
                </ul>
